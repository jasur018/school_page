  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-4">
        ...
        <p className="text-gray-500 font-medium text-lg">Loading applications...</p>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        {filteredApplications.length === 0 ? (
          <div className="text-center py-20 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
            ...
            <p className="text-gray-500 text-sm">When candidates submit the form, they'll appear here.</p>
          </div>
        ) : (
                ...
                <div className="px-5 pb-6 pt-2 border-t border-gray-50 bg-gray-50/30 rounded-b-2xl animate-in slide-in-from-top-2 duration-200">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-2">
                      ...
                      <div>
                        ...
                        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-[10px] font-medium text-gray-400 leading-none mb-1">Parent Name</p>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              <p className="text-[10px] font-medium text-gray-400 leading-none mb-1">Email Address</p>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-[10px] font-medium text-gray-400 leading-none mb-1">Phone Number</p>
                    ...
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                          <FileText className="w-3.5 h-3.5" /> Additional Message
                        </h5>
